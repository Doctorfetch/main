// A tiny rule-based "coach" so the chat feels alive without a backend.
// Match keywords -> pick a friendly, on-brand reply. Pure front-end demo.
...
const rules: Rule[] = [
  {
    test: /(tired|exhaust|no energy|lazy|cant be bothered|can't be bothered)/i,
    replies: [
  ...
  },
  {
    ...
    replies: [
      "Cardio mode! Easy pace, conversational — if you can't talk, slow down. Want intervals or a steady 25 min?",
      "Lace up. Let's do 5 min warm-up, then 6×1 min push / 90s float. Your last 5k pace was 5:42/km — beat it. 🏃",
    ],
  },
  {
    test: /(eat|food|meal|protein|diet|calorie)/i,
    replies: [
      "Fuel matters. Aim for a palm of protein + a fist of carbs post-workout. Want a quick high-protein snack idea? 🍳",
  ...
  },
  {
    ...
    replies: [
      "Sharp pain = stop. Dull soreness = normal. Where's it bugging you? We can swap the movement so you keep your streak. 🧊",
  ...
  },
  {
    ...
    replies: [
      "I've seen your last 3 weeks — you're stronger than you feel right now. Smallest possible step: put your shoes on. I'll wait. 👟",
